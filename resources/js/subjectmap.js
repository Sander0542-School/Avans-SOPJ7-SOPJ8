...
const map = Leaflet.map('mapid', {minZoom:16, maxZoom: 19, zoomControl: false, maxBounds: bounds, attributionControl: false}).setView([52.11662944833734, 6.595218386682539], 16);
